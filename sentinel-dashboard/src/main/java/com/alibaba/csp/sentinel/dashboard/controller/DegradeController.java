...
import com.alibaba.csp.sentinel.dashboard.client.NacosClient;
...
public class DegradeController {
    ...
    private boolean publishRules(String app, String ip, Integer port) {
        ...
        List<DegradeRuleEntity> rules = repository.findAllByMachine(MachineInfo.of(app, ip, port));
        try {
            List<DegradeRule> degradeRules = JSON.parseArray(JSON.toJSONString(rules), DegradeRule.class);
            return nacosClient.get().publishConfig("degrade-rules.json", app, JSON.toJSONString(degradeRules, true));
